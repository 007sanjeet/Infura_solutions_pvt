...
const Careers = () => {
  ...
  const careerCopy = content.careers_page || {
    ...
    introText:
      'We are always looking for driven, ethical, and ambitious recruiters and support specialists to join our corporate office.',
    cultureText:
      'We foster a collaborative, high-performance workspace where innovation is celebrated, integrity is mandatory, and personal growth is structured.',
    benefits: [
      {
        title: 'Uncapped Commissions',
        desc:
          'An industry-leading, transparent bonus structure rewarding your excellence.',
      },
      {
        title: 'Global Mobility',
        desc:
          'Opportunities to transfer across our London, New York, and Singapore hubs.',
      },
      {
        title: 'Wellness & Concierge',
        desc:
          'Comprehensive health cover, private gym memberships, and bespoke wellness benefits.',
      },
      {
        title: 'Continuous Mentorship',
        desc:
          'Direct learning paths coached by senior search partners and industry stalwarts.',
      },
    ],
  };
        ...
        <section className="bg-white rounded-lg border border-slate-100 p-8 md:p-12 shadow-card mb-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xs text-dark-muted font-sans leading-relaxed">
              At Infura Solutions, we maintain an atmosphere of professional
              dedication combined with flat-hierarchy accessibility. Our team
              members manage distinct recruitment verticals with autonomy,
              supported by top-tier search databases and intelligence tools.
            </p>
        ...
        <section className="space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-4">
            ...
            <h2 className="text-3xl font-serif text-dark font-semibold">
              Infura Career Benefits
            </h2>

            <p className="text-sm text-dark-muted font-sans">
              We design our compensation models and workplace benefits to
              secure high employee retention and support continuous career
              development.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {careerCopy.benefits.map((benefit, index) => (
              <div
                key={index}
                className="bg-white p-8 rounded-lg border border-slate-100 shadow-sm flex flex-col space-y-4 card-hover-effect"
              >
